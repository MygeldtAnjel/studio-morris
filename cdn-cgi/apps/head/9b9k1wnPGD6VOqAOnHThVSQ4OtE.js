;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="4fb4942a0eee5044dc69440ae3d4a352";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["0jpm0s2vH1Bk"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["0jpm0s2vH1Bk"].options={"account":{"accountId":"a9-1TsTcBjiG","service":"googleanalytics","userId":"115749253013801521905"},"anonymizeIp":false,"id":"","organization":"80480522","social":false,"web-properties-for-119410602":"UA-119410602-1","web-properties-for-80480522":"UA-80480522-2","webPropertySchemaNames":["web-properties-for-80480522","web-properties-for-119410602"]};;if(CloudflareApps.matchPage(CloudflareApps.installs['0jpm0s2vH1Bk'].URLPatterns)){(function(){var options=CloudflareApps.installs['0jpm0s2vH1Bk'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("0jpm0s2vH1Bk"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
